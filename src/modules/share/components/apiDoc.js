...
import TableHeaderShare from "./tableHeaderShare";
import TableQueryShare from "./tableQueryShare";
import RequestBodyShare from "./requestBodyShare";
                ...
                <div className={"share-box-right"}  id={"share-right-content"} >
                    <div className={"share-box-right-content"}>
                        <div className={"share-box-right-detail-content"}>
                            ...
                            <div className={"share-box-right-content-item"}>
                                <TableHeaderShare dataSource={apiDoc?.httpApi?.headerList}/>
                                <TableQueryShare dataSource={apiDoc?.httpApi?.queryList}/>
                                <RequestBodyShare data={apiDoc?.httpApi}/>
