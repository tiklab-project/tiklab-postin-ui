...
import { Table, Input, Tooltip, Form, Space, Checkbox, Divider } from 'antd';
        ...
        },
        {
            ...
            render: (text, record, index) =>(
                <Space>
                    ...
                    <Tooltip title="更新数据"><a onClick={() =>updateJsonParamDS(record)} > update </a></Tooltip>
                    <Tooltip title="删除数据"><a onClick={() =>deleteJsonParamDS(record.id)} type="primary"> delete </a></Tooltip>
